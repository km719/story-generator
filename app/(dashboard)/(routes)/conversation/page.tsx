            ...
            <div className="px-4 lg:px-8">
                ...
                <div className="space-y-4 mt-4">
                    ...
                    {messages.length === 0 && !isLoading && (
                        <Empty label="Conversation not found"/>
                    )}
                    <div className="flex flex-col-reverse gap-y-4">
                        {messages.map((message) => (
                            <div key={message.content as string} className={cn("p-8 w-full flex items-start gap-x-8 rounded-lg", message.role === "user" ? "bg-white border border-black/10" : "bg-muted")}>
